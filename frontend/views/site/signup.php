...
<div class="site-signup">
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <?=$form->field($model, 'residenza')->dropDownList(['' => 'Nessuna priorità', 'Caltanissetta' => 'Caltanissetta','Agrigento'=>'Agrigento','Trapani'=>'Trapani'],['prompt'=>'Seleziona una città'])->label('');?>
