...
class SiteController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup','index','profilo'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
    ...
    public function actionSignup()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->signup()) {
            Yii::$app->session->setFlash('success', 'La tua registrazione è andata a buon fine. Per effettuare l\'accesso dovrai aspettare che il tuo account venga approvato');
            return $this->goHome();
        }
