...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static function findByCf($codicefiscale)
    {
        return static::findOne(['codicefiscale' => $codicefiscale, 'status' => self::STATUS_ACTIVE]);
    }
    ...
    public function TimeValidate($attribute){
        if(Yii::$app->user->id != "") {
            $tempoinserito = User::find()->where(['id' => Yii::$app->user->id])->one();
